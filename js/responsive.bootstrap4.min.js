...
_display.modal=function(a){return function(c,b,e){if(!$.fn.modal)_original(c,b,e);else if(!b){if(a&&a.header){b=_modal.find("div.modal-header");var d=b.find("button").detach();b.empty().append('<h4 class="modal-title">'+a.header(c)+"</h4>").append(d)}_modal.find("div.modal-body").empty().append(e());_modal.appendTo("body").modal()}}};
